...
if(type.equals("ubuntuone")) {
    error=cloudUFS.renameFolder(ICloudFS.CloudType.UBUNTUONE, path, newPath);
} else if(type.equals("box")) {
    error=cloudUFS.renameFolder(ICloudFS.CloudType.BOX, path, newPath);
} else if(type.equals("dropbox")){
    error=cloudUFS.renameFolder(ICloudFS.CloudType.DROPBOX, path, newPath);
}
