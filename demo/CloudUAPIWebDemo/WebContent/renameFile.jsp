...
if(type.equals("ubuntuone")) {
    error=cloudUFS.renameFile(ICloudFS.CloudType.UBUNTUONE, path, newPath);
} else if(type.equals("box")) {
    error=cloudUFS.renameFile(ICloudFS.CloudType.BOX, path, newPath);
} else if(type.equals("dropbox")){
    error=cloudUFS.renameFile(ICloudFS.CloudType.DROPBOX, path, newPath);
}
