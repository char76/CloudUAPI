...
if(type.equals("ubuntuone")) {
    ...
    error=cloudUFS.copyFile(ICloudFS.CloudType.UBUNTUONE, path, newPath);
} else if(type.equals("box")) {
    error=cloudUFS.copyFile(ICloudFS.CloudType.BOX, path, newPath);
} else if(type.equals("dropbox")){
    error=cloudUFS.copyFile(ICloudFS.CloudType.DROPBOX, path, newPath);
}
