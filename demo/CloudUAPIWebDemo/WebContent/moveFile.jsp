...
if(type.equals("ubuntuone")) {
    error=cloudUFS.moveFile(ICloudFS.CloudType.UBUNTUONE, path, newPath);
} else if(type.equals("box")) {
    error=cloudUFS.moveFile(ICloudFS.CloudType.BOX, path, newPath);
} else if(type.equals("dropbox")){
    error=cloudUFS.moveFile(ICloudFS.CloudType.DROPBOX, path, newPath);
}
