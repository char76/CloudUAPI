...
if(type.equals("ubuntuone")) {
    error=cloudUFS.moveFolder(ICloudFS.CloudType.UBUNTUONE, path, newPath);
} else if(type.equals("box")) {
    error=cloudUFS.moveFolder(ICloudFS.CloudType.BOX, path, newPath);
} else if(type.equals("dropbox")){
    error=cloudUFS.moveFolder(ICloudFS.CloudType.DROPBOX, path, newPath);
}
